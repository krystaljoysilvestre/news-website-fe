...
class NavigationBar extends Component {
  ...
  render() {
    ...
    const { fetchNewsArticlesByCategory } = this.props;
      ...
      >
        <g id="surface1701463">
          <path
            ...
            d="M 86 76.21273 L 140.506223 21.72105 L 150.27895 31.493777 L 95.78727 86 L 150.613433 140.826163 L 140.826163 150.613433 L 86 95.78727 L 31.072037 150.613433 L 21.386567 140.927963 L 76.21273 86 L 21.72105 31.493777 L 31.493777 21.72105 Z M 86 76.21273 "
            transform="matrix(0.268605,0,0,0.268605,1.9,1.9)"
          />
          <path
            style={{
              stroke: 'none',
            ...
            d="M 10.359375 7.734375 L 7.734375 10.359375 L 22.371094 25 L 7.644531 39.753906 L 10.246094 42.355469 L 25 27.628906 L 39.726562 42.355469 L 42.355469 39.726562 L 27.628906 25 L 42.265625 10.359375 L 39.640625 7.734375 L 25 22.371094 Z M 10.359375 7.734375 "
          />
        </g>
      </svg>
    );
    ...
    return (
      <NB.Wrapper>
        ...
        <NB.Categories hidden={isSearchBarOpen}>
          <NB.Menu onClick={() => fetchNewsArticlesByCategory('business')}>
            Business
          </NB.Menu>
          <NB.Menu onClick={() => fetchNewsArticlesByCategory('entertainment')}>
            Entertainment
          </NB.Menu>
          <NB.Menu onClick={() => fetchNewsArticlesByCategory('health')}>
            Health
          </NB.Menu>
          <NB.Menu onClick={() => fetchNewsArticlesByCategory('science')}>
            Science
          </NB.Menu>
          <NB.Menu onClick={() => fetchNewsArticlesByCategory('sports')}>
            Sports
          </NB.Menu>
          <NB.Menu onClick={() => fetchNewsArticlesByCategory('technology')}>
            Technology
          </NB.Menu>
          <NB.Menu onClick={() => fetchNewsArticlesByCategory('general')}>
            General
          </NB.Menu>
        </NB.Categories>
        <NB.Menu onClick={() => this.toggleSearchBar(!isSearchBarOpen)}>
          <NB.SearchBar active={isSearchBarOpen}>
            {isSearchBarOpen ? (
              ...
              >
                ...
                />
                <span onClick={() => this.toggleSearchBar(!isSearchBarOpen)}>
                  {closeIcon}
                </span>
              </span>
            ) : (
